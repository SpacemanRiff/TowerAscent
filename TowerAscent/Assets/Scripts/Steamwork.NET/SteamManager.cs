...
class SteamManager : MonoBehaviour {
    ...
    private void Awake() {
        ...
        try {
            ...
            if (SteamAPI.RestartAppIfNecessary((AppId_t)560340)) {
                Application.Quit();
                return;
            }
    ...
    public static void HeadshotAchievement() {
        //SteamUserStats.ClearAchievement("headshot");
        //SteamUserStats.StoreStats();
        bool achieved;
        bool successful = SteamUserStats.GetAchievement("headshot", out achieved);
        if (successful) {
            if (!achieved) {
                SteamUserStats.SetAchievement("headshot");
                SteamUserStats.StoreStats();
                print("We Got It!");
            } else {
                print("Achieved");
    ...
    public static void ArrowGrabAchievement() {
